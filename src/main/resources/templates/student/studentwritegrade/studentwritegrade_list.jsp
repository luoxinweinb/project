...
<form action="studentwritegrade/list1.do"  method="post" class="form-inline">
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
    ...
    <input  type="button" onclick="javascript:location='studentwritegrade/loadadd.do'"  value="添加学生成绩"/>
</div>
</form>
...
<div class="row" style="padding:15px; padding-top:0px; " align="right">
	<display:table class="table  table-condensed table-striped" name="list"  id="cc"  pagesize="10" requestURI="studentwritegrade/list.do">
		...
		<display:column href="studentwritegrade/loadupdate.do" paramId="writeGradeId" paramProperty="writeGradeId" value="修改"  title="修改"/>
