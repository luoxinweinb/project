            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                		<select name="staffEductionLevel"  class="form-control input-sm" >
                            ...
                            <option ${staffInfo.staffEductionLevel=='专科'?'selected':'' }>专科</option>
                        </select>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                		<select name="staffState"  class="form-control input-sm" >
                            <option value="1" ${staffInfo.staffState=='1'?'selected':'' }>教务人员</option>
                            <option value="2" ${staffInfo.staffState=='2'?'selected':'' }>任课教师</option>
                            <option value="3" ${staffInfo.staffState=='3'?'selected':'' }>班主任</option>
                        </select>
                </div>
            </div>
        </div>    
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="password" name="userPassowrd" value="${staffInfo.userPassowrd }" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    </div>
