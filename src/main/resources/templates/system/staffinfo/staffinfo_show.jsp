...
<form action="" class="form-horizontal" method="post">
	...
	<div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <p class="form-control-static">${staffInfo.staffState=='1'?'教务人员':staffInfo.staffState=='2'?'任课教师':'班主任' }</p>
    ...
    <br/>	 <br/>	
  	<div class="row">
    	...
    	<input  type="button" onclick="javascript:location='system/load.do?staffId=${staffInfo.staffId }'"  value="修改"/>&nbsp;&nbsp;
    	<input  type="button" onclick="javascript:location='system/delete.do?staffId=${staffInfo.staffId }'"  value="删除"/>&nbsp;&nbsp;
    	<input  type="button" onclick="javascript:location='system/list.do'"  value="返回上一级"/>
        </div>
    </div>
