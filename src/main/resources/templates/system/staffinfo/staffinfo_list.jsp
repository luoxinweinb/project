...
<form action="system/list.do" method="post" class="form-inline">
    ...
    <input type="button"    value="添加" onClick="javascript:window.location='view/system/staffinfo/staffinfo_add.jsp'"/>
</form>
</div>
