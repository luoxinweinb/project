...
<form action="anthorty/update.do" class="form-horizontal"  method="post">
	...
	<div class="row">
    	<div class="col-xs-5">
        	<div class="form-group">
                ...
                <div class="col-xs-9">
                	<input type="text" name="anthortyId" value="${anth.anthortyId }" readonly="readonly"  class="form-control input-sm" placeholder=" "/>
                </div>
            </div>
        ...
        <div class="col-xs-5">
            <div class="form-group">
                ...
                <div class="col-xs-9">
                	<input type="text" name="anthortyName" value="${anth.anthortyName }" class="form-control input-sm" placeholder=" "/>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-xs-5">
            <div class="form-group">
                ...
                <div class="col-xs-9">
                	<input type="text" name="anthortyUrl"  value="${anth.anthortyUrl }" class="form-control input-sm" placeholder=" "/>
                </div>
            </div>
        </div>
    </div>
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">备注信息</h5>
 	...
 	<div class="row">
    	<div class="col-xs-3 col-xs-offset-3">
        	<input  type="submit"   value="修改权限信息"/>
        </div>
    </div>
