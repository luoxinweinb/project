...
<form action="roleinfo/changeRole.do" method="post" class="form-horizontal">
    ...
    <!-- 结束3 -->
   	<div class="row">
    	<div class="col-sm-5 col-sm-offset-4">
          	<input type="submit"   value="角色变更"/>&nbsp;
          	&nbsp;
          	<input  type="button" onclick="javascript:location='roleinfo/staffinforolelist.do'"  value="返回上一级"/>
