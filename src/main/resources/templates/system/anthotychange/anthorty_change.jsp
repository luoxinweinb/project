    ...
    */
     ...
     <tr>
    	<td>
        	<label class="checkbox-inline">
            	<input type="checkbox" id="all" name="anthortyId" <%
            	//if(dto.getAnth().getChecked()){ out.print("checked"); } %>  value="<%=//dto.getAnth().getAnthortyId() %>"><%=//dto.getAnth().getAnthortyName() %>
             </label>
        </td>
    	<td>
    		<%  
	...
	//}} %>
    	...
    	<div class="col-sm-5 col-sm-offset-4">
          	<input type="submit"   value="权限变更"/>&nbsp;&nbsp;
          	<input  type="button" onclick="javascript:location='anthotychange/list.do'"  value="返回上一级"/>
