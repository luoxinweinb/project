...
<form action="studentpayment/payment.do" method="post" class="form-horizontal">
   ...
   <!--结束 -->
   <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">学生缴费信息登记</h5>
       ...
       <!--开始 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                   <select onchange="query(this)" name="paymentSituation" class="form-control  input-sm">
    		           <option value="">请选择学年</option>
               			  ...
               			  <option value="2018-2019学年">2019-2020学年</option>
                    </select>
       ...
       <!--开始 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		<input type="text" name="paymentTime"  onclick="laydate()"  class="form-control input-sm"  placeholder="格式：yyyy-mm-dd"/>
                 </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="shouldAmount" id="shouldAmount" class="form-control input-sm" placeholder=""/>
                 </div>
            </div>
        </div>
    </div>
       ...
       <!--开始 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		<input type="text" name="discountAmount"  value="0" id="discountAmount" class="form-control input-sm" placeholder=""/>
                 </div>
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="realAmount" onblur="total()"  id="realAmount" class="form-control input-sm" placeholder=""/>
                 </div>
            </div>
        </div>
    </div>
       ...
       <!--开始 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		<input type="text" name="debtAmount"  id="debtAmount" class="form-control input-sm" placeholder=""/>
                 </div>
            </div>
        </div>
