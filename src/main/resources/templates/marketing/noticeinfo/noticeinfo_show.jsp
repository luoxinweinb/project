...
<form action="noticeinfo/update.do" enctype="multipart/form-data"  class="form-horizontal" method="post">
	...
	<div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="noticeId" value='${mess.noticeId }' readonly="readonly"  class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
           ...
           <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="noticeTitle" value='${mess.noticeTitle }' class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    </div>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" name="noticeTime" value='<fmt:formatDate value="${mess.noticeTime }"/>'   onclick="laydate()"   class="form-control input-sm" placeholder="格式：yyyy-mm-dd"/>
                </div>
            </div>
       ...
       <div class="col-sm-5">
        	<div class="form-group">
                ...
                <select name="staffId" class="form-control input-sm">
                  <option value='${mess.staffId }'>${mess.staffName }</option>
                </select>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">通知内容信息</h5>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea id="noticeContent" rows="13"  cols="140" name="noticeContent"  >${mess.noticeContent }
