	...
	<div class="row">
    	...
    	<div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="messafeMan" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="messafePhone" class="form-control input-sm"  placeholder=""/>
                </div>
            </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">短信内容信息</h5>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
            ...
            <input  type="button" onclick="javascript:location='messafeinfo/list.do'"  value="返回上一级"/>
