	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="templateId" value="${templateInfo.templateId }" readonly="readonly" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="templateTitle" value="${templateInfo.templateTitle }" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
