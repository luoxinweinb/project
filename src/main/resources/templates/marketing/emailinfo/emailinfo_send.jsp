	...
	<div class="row">
    	<div class="col-sm-5">
     	...
     	<div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="emailTitle" id="emailTitle" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    	...
    	<div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="emailMan" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="emailAddr" class="form-control input-sm"  placeholder=""/>
                </div>
            </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit"   value="发送"/>
             <input  type="button" onclick="javascript:location='email/list.do'"  value="返回上一级"/>
