...
<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				...
				<h3><font color="white">AHEAD信息分院教务管理系统V1.0</font></h3>
				...
				<ul class="nav ace-nav">
					...
					<li >
						...
						<ul
							...
							<li><a  href="system/show.do?staffId=${staff.staffId}"   target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>
			   ...
			   // if(dtolist!=null&& dtolist.size()>0){
			    ...
			    <a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <span
							class="menu-text"> <%//=dto.getAnth().getAnthortyName() %> </span> 
