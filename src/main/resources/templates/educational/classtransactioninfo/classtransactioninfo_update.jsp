	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="classTransactionId" readonly="readonly" value="${transactinfo.classTransactionId }" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="classTransactionTitle" value="${transactinfo.classTransactionTitle }" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="classTransactionPerson" value="${transactinfo.classTransactionPerson }" class="form-control input-sm" placeholder=""/>
                </div>
            </div>
        </div>
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               		 <input type="text" name="classTransactionTime"  value='<fmt:formatDate value="${transactinfo.classTransactionTime }"/>'  onclick="laydate()"   class="form-control input-sm" placeholder="格式：yyyy-mm-dd"/>
                </div>
            </div>
