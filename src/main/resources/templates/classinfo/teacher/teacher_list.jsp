...
<form action="teacher/list.do" method="post" class="form-inline">
	  <div class="form-group">
    	...
    	<select onchange="query(this)" name="condititon" class="form-control  input-sm">
            ...
            <option value="staffNativePlace">籍贯</option>
            <option value="staffEductionLevel">学历</option>
        </select>
        <input type="text"  id="keyword" class="form-control input-sm"/>
      </div>
      <input type="submit"     value="查询"/>&nbsp;&nbsp;
      <input type="button"     value="添加" onClick="javascript:window.location='view/classinfo/teacher/teacher_add.jsp'"/>
</form>
</div>
...
<div align="center">
	<div class="alert alert-warning" style="margin: 0px; padding: 5px; width: 80%;display:${empty info?'none':'block'} ">
		...
		<p align="center" style="color: red;">教师信息-${info }</p>
	</div>	
</div>
