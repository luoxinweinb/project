...
<form action="syllabusinfo/list.do" method="post" class="form-inline">
 <div class="row alert alert-info"  style="margin:0px; padding:3px;" >
      <div class="form-group">
         <label class="" for="syllabusName">班级课程表名称：</label>
        <input type="text" name="syllabusName" class="form-control" id="syllabusName" placeholder="">
      </div>
    <input type="submit"    value="查询"/>&nbsp;&nbsp;
    <input  type="button" onclick="javascript:location='view/classinfo/syllabusinfo/syllabusinfo_add.jsp'"  value="添加班级课程表"/>
</div>  
</form>
